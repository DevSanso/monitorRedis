...
pub static COLLECT_COMMANDLINE_MAP: once_cell::sync::Lazy<HashMap<CollectCommand, &'_ str>> =
    once_cell::sync::Lazy::new(|| {
        ...
        collect_commandline_map_internal.insert(CollectCommand::CommonMem," INSERT INTO comm_mem (   server_id,   collect_time,   total,   usage_kb,   free_kb  ) VALUES ( $1, now(), $2, $3, $4) ");
